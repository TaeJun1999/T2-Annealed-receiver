...
nohup env CUDA_VISIBLE_DEVICES=2 $P code/fit_gpu.py 8 kron 512 160000 >> $L 2>&1 &
nohup env CUDA_VISIBLE_DEVICES=3 $P code/fit_gpu.py 8 kron 256 160000 >> $L 2>&1 &
nohup env CUDA_VISIBLE_DEVICES=4 $P code/fit_gpu.py 4 kron 512 160000 >> $L 2>&1 &
nohup env CUDA_VISIBLE_DEVICES=5 $P code/fit_gpu.py 8 full 512 160000 >> $L 2>&1 &
wait
